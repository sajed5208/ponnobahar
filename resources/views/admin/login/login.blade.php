...
<head>
    ...
    <!-- iCheck -->
    <link href="{{asset('adminStyle')}}/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Ponnobahar Admin</b></a>
    </div><!-- /.login-logo -->
